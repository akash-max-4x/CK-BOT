...
module.exports.run = async function ({ event, api, args }) {    
  ...
  if (!mention[0]) return api.sendMessage("Please mention 1 person.", threadID, messageID);
      ...
      return makeImage({ one, two }).then(path => api.sendMessage({ body: "অনেক༎ইচ্ছে༎করে তোমাকে খুব শক্ত༎করে জড়িয়ে ধরে বলি༎ভালোবাসি.....//🌼", attachment: fs.createReadStream(path) }, threadID, () => fs.unlinkSync(path), messageID));
  }
    }