...
module.exports.handleEvent = async ({ event, api }) => {
  ...
  const sensitiveKeywords = ["i will kill you", "i will stab you", "kill you", "stab you", "fuck you", "you idiot", "motherfucker", "বাল", "মাদারদোচ", "বোকাচোদা", "খানকি", "মাগি", "Magi", "bal", "Sex", "sex", "SEX", "xxx", "xnxx", "Xxx", "XXX", "XNXX", "Xnxx", "Bal", "BAL"]; // Dagdagan mo lang kung gusto mong maraming keywords 
